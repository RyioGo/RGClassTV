...
export default class esfzydjjsdqldghCom extends Vue {
  //  表单步骤
  active = 0;
  //  相关字典
  dict = dict;
  ...
  form: any = {
    ...
    bilv: {
      ...
      sellerEms: "",
      sellerOther: "",
      sellerTime: moment().format("YYYY年MM月DD"),
    },
    marriage: {
      buy: {
        name: "",
        ...
        divorceTime: "",
        dieTime: "",
        creteTime: moment().format("YYYY年MM月DD"),
      },
      sell: {
        name: "",
        gender: "",
  ...
  setData(): void {
    ...
    this.form.marriage.tc_buy.name = this.form.marriage.buy.name;
    this.form.marriage.tc_buy.credentialName =
      this.form.marriage.buy.credentialName;
    this.form.marriage.tc_buy.credentialNum =
      this.form.marriage.buy.credentialNum;

    // 税务证明文档-售卖
    this.form.marriage.tc_sell.name = this.form.marriage.sell.name;
    this.form.marriage.tc_sell.credentialName =
      this.form.marriage.sell.credentialName;
    this.form.marriage.tc_sell.credentialNum =
    ...
    <div class="rg-form-data">
      ...
      <div v-show="active == 2">
        ...
        <van-cell-group style="margin-top: 8px">
          ...
          <van-field
            ...
            placeholder="房屋总价(万元)"
            required
            :rules="[{ required: active == 2, message: '房屋总价' }]"
          />
          <van-field
            label="房屋总价"
      ...
      <div v-show="active == 4">
        <van-cell-group style="margin-top: 8px">
          ...
          <van-field
            label="配偶姓名"
            v-model="form.marriage.tc_buy.spouseName"
            placeholder="请填写配偶姓名"
          />
          <van-field
            label="配偶证件号"
            v-model="form.marriage.tc_buy.spouseNum"
            placeholder="请填写配偶证件号"
          />
          <van-field
            label="子女"
            v-model="form.marriage.tc_buy.childName1"
            placeholder="请填写子女"
          />
          <van-field
            label="子女证件号"
            v-model="form.marriage.tc_buy.childNum1"
            placeholder="请填写子女证件号"
          />
          <van-field
            label="子女"
            v-model="form.marriage.tc_buy.childName2"
            placeholder="请填写子女"
          />
          <van-field
            label="子女证件号"
            v-model="form.marriage.tc_buy.childNum2"
            placeholder="请填写子女证件号"
          />
          ...
          <van-field
            ...
            maxlength="50"
            show-word-limit
            v-model="form.marriage.tc_buy.location"
            placeholder="请填写现居住地"
          />
        ...
        <van-cell-group style="margin-top: 8px">
          ...
          <van-field
            label="配偶姓名"
            v-model="form.marriage.tc_sell.spouseName"
            placeholder="请填写配偶姓名"
          />
          <van-field
            label="配偶证件号"
            v-model="form.marriage.tc_sell.spouseNum"
            placeholder="请填写配偶证件号"
          />
          <van-field
            label="子女"
            v-model="form.marriage.tc_sell.childName1"
            placeholder="请填写子女"
          />
          <van-field
            label="子女证件号"
            v-model="form.marriage.tc_sell.childNum1"
            placeholder="请填写子女证件号"
          />
          <van-field
            label="子女"
            v-model="form.marriage.tc_sell.childName2"
            placeholder="请填写子女"
          />
          <van-field
            label="子女证件号"
            v-model="form.marriage.tc_sell.childNum2"
            placeholder="请填写子女证件号"
          />
          <!-- 
          <RGPicker
          ...
          <van-field
            ...
            maxlength="50"
            show-word-limit
            v-model="form.marriage.tc_sell.location"
            placeholder="请填写现居住地"
          />
          <van-cell title="无配偶情况" titleClass="sub-title" />
          <RGDataPicker
